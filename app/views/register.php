                    ...
                    <div class="card-body">
                        ...
                        <form id="registerForm" method="post" action="/register" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="nom" name="nom" class="form-control <?= cls_invalid($errors, 'nom') ?>"
                                    value="<?= e($values['nom'] ?? '') ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email" name="email" class="form-control <?= cls_invalid($errors, 'email') ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="invalid-feedback" id="passwordError"><?= e($errors['password'] ?? '') ?>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="invalid-feedback" id="telephoneError"><?= e($errors['telephone'] ?? '') ?>
                                </div>
                            </div>
